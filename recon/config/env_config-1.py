...
class Config:
    ...
    COMMON_SUBDOMAINS = [
        "www", "mail", "ftp", "webmail", "vpn", "remote", "exchange",
        "autodiscover", "ns1", "ns2", "mx1", "mx2", "api", "dev", "test",
        "blog", "shop", "support", "portal", "admin", "secure"
    ]
    ...
    def update_network_config(self, interface=None, target_domain=None):
        if interface:
