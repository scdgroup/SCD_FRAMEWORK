...
class ModelInspector:
    def __init__(self, model_path=None):
        ...
        # Fix: Use load_checkpoint instead of load
        ...
        self.agent.load_checkpoint(m_path, mem_path, eps_path)
        
        # Check if model state size matches
    ...
    def predict_best_actions_for_scenarios(self):
        """
        Simulates different scenarios (states) and sees what the model prefers.
        """
        scenarios = {
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Inspect Model (.h5) knowledge")
    parser.add_argument("--model", type=str, help="Path to the .h5 model file")
